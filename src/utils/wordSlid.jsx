...
const wordSlid = [
  ...
  {
    name: "IT Skill Acquisition",
    url: "/it-skill-acquisition",
    detail: "Empower Your Career with New Skills",
    define:
      "Enhance your IT capabilities with our comprehensive training programs.",
    image: img4,
    additionalInfo: [
      ...
      "Cloud Computing: AWS, Azure, and Google Cloud training.",
      "Cybersecurity: Protect your systems and data with our security courses.",
    ],
    explain: [
      {
        e_p1: "At Altair Attic Limited, we offer comprehensive IT skill acquisition programs designed to equip individuals with the technical skills needed in the information technology industry. Our training covers programming, networking, cybersecurity, and data analysis, preparing participants for various roles, from software developers to IT support specialists. We provide a blend of formal education, online courses, certifications, and hands-on experience.",
        e_p2: "The demand for IT professionals is ever-increasing, driven by technological advancements and digital transformation. Continuous learning is essential, and our programs ensure participants stay relevant and competitive. By acquiring IT skills through Altair Attic Limited, individuals enhance their career prospects and contribute to innovative projects. Our accessible learning resources empower anyone with a passion for technology to succeed in the IT field.",
      },
    ],
    choose:
      " Empower yourself with essential tech skills through our comprehensive, hands-on training programs designed for all experience levels.",
    success:
      " Empowering your success with comprehensive, hands-on training programs designed to equip you with essential tech skills for career advancement.",
    Q1: {
      Question: "What IT skills can I learn through your programs?",
      Answer:
        "Our programs cover a wide range of skills, including programming, cybersecurity, data analysis, and more.",
    },
    Q2: {
      Question: "Are your training programs suitable for beginners?",
      Answer:
        "Yes, we offer courses for all experience levels, from beginners to advanced professionals.",
    },
    Q3: {
      Question: "Do you provide certification upon completion?",
      Answer:
        "Yes, participants receive certification upon successful completion of our training programs.",
    },
  },
];
